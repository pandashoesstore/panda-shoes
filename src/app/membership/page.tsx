...
export default function MembershipPage() {
  const perks = [
    ...
    { icon: '👟', title: '15-Day Wear Test', desc: "Wear them for real. If they're not right within 15 days, bring them back for store credit or an exchange." },
  ...
  const details = [
    ...
    { num: '02', title: '15-Day Wear Test', desc: 'Members have 15 days from purchase to bring shoes back if they are not the right fit. Returns within the wear test are issued as store credit or exchange only. Shoes should be in clean, wearable condition.' },
    ...
    <StoreLayout>
      <section className={styles.hero}>
        <div className="container">
          ...
          <p className={styles.heroSub}>Join free and unlock store credit, easy exchanges, a 15-day wear test, and free local delivery across Bergen &amp; Hudson County.</p>
